...
<head>
  ...
  <script type='text/javascript'>
    function abrirRegiaoBeloHorizonte(){openLevel('', {})}
    function abrirMontesClaros(){openLevel('', {})}
    function abrirTeofiloOtoni(){openLevel('', {})}
    function abrirGovernadorValadares(){openLevel('', {})}
    function abrirIpatinga(){openLevel('', {})}
    function abrirJuizdeFora(){openLevel('', {})}
    function abrirVarginha(){openLevel('', {})}
    function abrirPousoAlegre(){openLevel('', {})}
    function abrirUberaba(){openLevel('', {})}
    function abrirUberlandia(){openLevel('', {})}
    function abrirPatosdeMinas(){openLevel('', {})}
    function abrirDivinopolis(){openLevel('', {})}
  </script>
</head>
<body>
<div id="container">
